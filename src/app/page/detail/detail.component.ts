...
export class DetailComponent implements OnInit {
  ...
  imageFilter = [
    ...
    {"id":10,"type":"INTERIOR","img":"../../../assets/interior/interior_bulakul/บลูลากูน4.png","text":"Interior&Furniture บ้านพักอาศํย @ มบ.บลูลากูน","url":"../../../assets/interior/interior_bulakul/",
    ...
    {"id":18,"type":"rock","img":"../../../assets/Decor-งานหิน/หิน@Mo-Mo-Paradiseเซนทรัลเวิล/หิน momo1.png","text":"หิน MO-MO PARADISE","url":"../../../assets/Decor-งานหิน/หิน@Mo-Mo-Paradiseเซนทรัลเวิล/",
    ...
    {"id":20,"type":"rock","img":"../../../assets/Decor-งานหิน/หิน@นิคมไฮเทคอยุธยา/หิน อยุธยา4.png","text":"งานหิน นิคมไฮเทค อยุธยา","url":"../../../assets/Decor-งานหิน/หิน@นิคมไฮเทคอยุธยา/",
  ...
  ngOnInit(): void {
    ...
    if(history.state.navigationId != 1){
      ...
      this.idProject = this.imageDetail.idProject;
      this.project = this.imageFilter.filter(x =>x.id === this.idProject) //วิธีฟิลเตอร์
      this.type = this.imageDetail.type;
