...
export class DetailComponent implements OnInit {
  ...
  imageFilter = [
    ...
    {"id":17,"type":"CONSTRUCTION","img":"../../../assets/construction/โกดังปากน้ำ/โกดัง1.png","text":"งานก่อสร้าง โกดัง ","url":"../../../assets/construction/โกดังปากน้ำ/",
      "detail":"งานออกแบบและก่อสร้างโกดัง เก็บอะไหล่รถยนต์ คอนเช็ปการออกแบบเป็นโกดังกึ่งโรงงาน 2ชั้น โดยใช้โครงสร้างเหล็กทั้งหมด วัสดุผนังและหลังคาเป็นเมทัลชีท เดินระบบไฟร้อยท่อ EMT เพื่อความปลอดภัย","year":"2563","place":"ซอยมิตรไมตรี จ.สมุทรปราการ"},
